...
let IconFinding: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconFinding.defaultProps = {
  size: 18,
};

IconFinding = React.memo ? React.memo(IconFinding) : IconFinding;

export default IconFinding;
